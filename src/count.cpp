...
void check_call_node(const char *type, bool &is_parent_call) {
    // types of function nodes: call, call_expression, binary_expression(eg: std::cout << "hello")
...
// name of the function called is met in the node which is met before meeting the arguement list node
void check_call_identifier_end(const std::string identifier, const std::string &feature, const char *type, int &count, bool &is_parent_call) {
